...
class Cars(pygame.sprite.Sprite):
	def __init__(self):
		...
		self.y_list = [80,210,340,470]
		self.rect.y = random.choice(self.y_list)
		
		self.speedy = 0
		self.speedx = randint(-7,-2)
...
class Objects1(pygame.sprite.Sprite):
	def __init__(self):
		...
		self.y21_list = [0,1,2,3,4,5]
		self.rect.y = random.choice(self.y21_list)
...
class Objects2(pygame.sprite.Sprite):
	def __init__(self):
		...
		self.rect = self.image.get_rect()
		self.rect.x = (WIDTH + self.rect.width)
		self.y22_list = [580,585,586,587,588,589, 590]
		self.rect.y = random.choice(self.y22_list)
...
def show_go_screen():
	...
	draw_text1(screen, "Esquiva vehículos, colecta bidones y oro", 20, WIDTH // 2, HEIGHT // 2)
	draw_text1(screen, "Press Key Q", 20, WIDTH // 2, HEIGHT * 3/4)
...
def fnd():
	screen.blit(random.choice(fnd_images),[0,0])
...
cars_images = []
cars_list = ["img/au1.png", "img/au2.png",  "img/au3.png", "img/au4.png", "img/au5.png", 
"img/au6.png", "img/au7.png","img/truck1.png", "img/truck2.png", "img/truck3.png", "img/Trac.png"]
...
background = pygame.image.load("img/fond11.png").convert()
